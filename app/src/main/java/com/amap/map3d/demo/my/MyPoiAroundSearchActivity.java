 ...
 * 介绍poi周边搜索功能
 */
public class MyPoiAroundSearchActivity extends Activity implements OnClickListener,
...
OnPoiSearchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_poiaroundsearch_activity);
			...
			if (result != null && result.getQuery() != null) {// 搜索poi的结果
				if (result.getQuery().equals(query)) {// 是否是同一条
					...
					if (poiItems != null && poiItems.size() > 0) {
						...
						ToastUtil.show(MyPoiAroundSearchActivity.this,
								R.string.no_result);
					}
				}
			} else {
				ToastUtil
						.show(MyPoiAroundSearchActivity.this, R.string.no_result);
			}
		} else  {
